...
Last updated: 2026-07-12 (total: **71 steps**, plus 3 optional appendix steps)
...
| [Chapter 4](Chapter%204/README.md) — RAG optimization | **14** (+3 appendix) | 1–14, chapter-wide; appendix A1–A3 | Single chunked `bookstore-rag` index built up front. A1–A3 (external LLM + agent) need an API key |
| [Chapter 5](Chapter%205/README.md) — Production optimizations | **11** | 1–11, chapter-wide | Awareness, watermarks, shrink recipe, security, priority tiers, and backpressure are read-along **Reference** blocks, not steps |
