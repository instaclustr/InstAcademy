...
**Chapter 5 · Lesson 3** — k-NN **vector storage modes** and the latency vs memory trade-off.
...
- **Chapter 5 · Lesson 4 (theory only):** secure, resilient AI apps — no dedicated lab folder ([Chapter 5 overview](../README.md)).
