...
Usage:
    ...
    python verify_corpus.py --corpus example-corp-corpus-v1.0.0
"""
import argparse
import hashlib
import json
...
def main():
    ...
    print("Next: python ingest_opensearch.py --model-id <MODEL_ID> "
          f"--dimension 384 --chunks {root / 'chunks.jsonl'}")
