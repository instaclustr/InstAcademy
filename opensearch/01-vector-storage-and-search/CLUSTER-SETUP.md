← [Course index](README.md) · [How to run labs](HANDS-ON-GUIDE.md) · **Next:** [Chapter 1](chapters/01-configuring-vector-search/README.md)
...
2. [Create the cluster](#2-create-the-opensearch-cluster) — name it, pick OpenSearch, add the **AI Search Plugin**, size the nodes
...
>Start at the [NetApp Instaclustr free trial](https://console2.instaclustr.com/signup?source=InstAcademy_OpenSearch_AI_Search) and fill out the sign-up form.
...
![Choose the m.80 node size](assets/cluster-setup/node_size.png)
...
> [!TIP]
> **Cluster running? Connection details saved?** Then head to [Chapter 1](chapters/01-configuring-vector-search/README.md), or read [how to run the labs](HANDS-ON-GUIDE.md) first if you haven't yet.
