← **Previous:** [How to run the labs](../../HANDS-ON-GUIDE.md) · [Course index](../../README.md) · [How to run labs](../../HANDS-ON-GUIDE.md) · **Next:** [Chapter 2](../02-neural-search-pipelines/README.md) →
...
[Bruno fast mode](../../bruno/01-configuring-vector-search/)).
...
![From raw data to a point in vector space](../../assets/01-configuring-vector-search/diagram-01-data-to-vectors.png)
...
![Inside the index: nodes, shards, and segments, before and after force-merge](../../assets/01-configuring-vector-search/diagram-02-shards-segments-force-merge.png)
...
![shard_location](../../assets/01-configuring-vector-search/step05-shard-distribution.png)
...
![shard_location](../../assets/01-configuring-vector-search/step05-segments-before-merge.png)
...
![shard_location](../../assets/01-configuring-vector-search/step05-single-segment-after-merge.png)
...
![Disk-based storage: the two-phase quantize-then-rescore search](../../assets/01-configuring-vector-search/diagram-03-disk-based-two-phase-search.png)
...
![HNSW layered graph versus IVF centroid buckets](../../assets/01-configuring-vector-search/diagram-04-hnsw-vs-ivf.png)
...
![The 10 product vectors: three clusters and the query point](../../assets/01-configuring-vector-search/diagram-05-product-vector-clusters.png)
...
![response](../../assets/01-configuring-vector-search/step08-bulk-products-response.png)
...
![The IVF pipeline: train a model, then build the index from it](../../assets/01-configuring-vector-search/diagram-06-ivf-training-pipeline.png)
...
![Truncation versus chunking for long documents](../../assets/01-configuring-vector-search/diagram-07-truncation-vs-chunking.png)
...
![256-dim footprint](../../assets/01-configuring-vector-search/step15-256dim-footprint.png)
...
![Dimension reduction: 256 floats in, 128 floats out](../../assets/01-configuring-vector-search/diagram-08-dimension-reduction.png)

![index-sizes](../../assets/01-configuring-vector-search/step16-footprint-comparison.png)
...
[Chapter 2](../02-neural-search-pipelines/README.md) — register a real embedding model and build a
neural search pipeline.

---

🚀 **Next:** [Chapter 2](../02-neural-search-pipelines/README.md)
